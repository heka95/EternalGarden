...
namespace Garden
{
    ...
    {
        static_assert(std::is_base_of<BaseComponent, T>::value, "Only Component can be defined");
    ...
    public:
        ...
        bool add(Entity entity, BaseComponent *component) { return m_store->add(entity, component); }
